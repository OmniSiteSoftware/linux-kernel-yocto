...
/* WF50DTYA3MNG10 — ILI9881C — 720x1280 — 2-lane DSI — RGB888 — VIDEO BURST */
static const struct ili9881c_instr WF50DTYA3MNG10_init[] = {
	...
	ILI9881C_COMMAND_INSTR(0x6C, 0x15),
	ILI9881C_COMMAND_INSTR(0x6E, 0x2B), // Power control 2: VGH clamp level
	ILI9881C_COMMAND_INSTR(0x6F, 0x33), // Power control 3: VGH & VGL step-up factor
	ILI9881C_COMMAND_INSTR(0x8D, 0x18), // Power control 4: VGL clamp level
	ILI9881C_COMMAND_INSTR(0x87, 0xBA), // LVD function 1: undervoltage sensitivity
	ILI9881C_COMMAND_INSTR(0x26, 0x76), // Internal SD timing control
	ILI9881C_COMMAND_INSTR(0xB2, 0xD1), // Reload gamma
	ILI9881C_COMMAND_INSTR(0xB5, 0x06), // Gamma bias
	ILI9881C_COMMAND_INSTR(0x3A, 0x24), // Power saving control
	ILI9881C_COMMAND_INSTR(0x35, 0x1F), // Source timing

#if 0
	// BIST (ILI9881C-04 Specification, page 236)
	ILI9881C_COMMAND_INSTR(0x2F, 0x01),
	ILI9881C_COMMAND_INSTR(0x2D, 0x20),
#endif

	ILI9881C_SWITCH_PAGE_INSTR(1),

	ILI9881C_COMMAND_INSTR(0x22, 0x09), // BGR, GS
	ILI9881C_COMMAND_INSTR(0x31, 0x00), // Column inversion
	ILI9881C_COMMAND_INSTR(0x40, 0x33), // Pump clock adjust
	ILI9881C_COMMAND_INSTR(0x53, 0xA2), // VCOM control 1 (VCM1)
	ILI9881C_COMMAND_INSTR(0x55, 0x92), // VCM2
	ILI9881C_COMMAND_INSTR(0x50, 0x96), // Power control 1 (VREG1)
	ILI9881C_COMMAND_INSTR(0x51, 0x96), // VREG2
	ILI9881C_COMMAND_INSTR(0x60, 0x22), // Source timing adjust (SDT)
	ILI9881C_COMMAND_INSTR(0x61, 0x00), // CRT
	ILI9881C_COMMAND_INSTR(0x62, 0x19), // EQT
	ILI9881C_COMMAND_INSTR(0x63, 0x00), // PCT

	// P-GAMMA
	ILI9881C_COMMAND_INSTR(0xA0, 0x08), // VP255
	ILI9881C_COMMAND_INSTR(0xA1, 0x11), // VP251
	ILI9881C_COMMAND_INSTR(0xA2, 0x19), // VP247
	ILI9881C_COMMAND_INSTR(0xA3, 0x0D), // VP243
	ILI9881C_COMMAND_INSTR(0xA4, 0x0D), // VP239
	ILI9881C_COMMAND_INSTR(0xA5, 0x1E), // VP231
	ILI9881C_COMMAND_INSTR(0xA6, 0x14), // VP219
	ILI9881C_COMMAND_INSTR(0xA7, 0x17), // VP203
	ILI9881C_COMMAND_INSTR(0xA8, 0x4F), // VP175
	ILI9881C_COMMAND_INSTR(0xA9, 0x1A), // VP144
	ILI9881C_COMMAND_INSTR(0xAA, 0x27), // VP111
	ILI9881C_COMMAND_INSTR(0xAB, 0x49), // VP80
	ILI9881C_COMMAND_INSTR(0xAC, 0x1A), // VP52
	ILI9881C_COMMAND_INSTR(0xAD, 0x18), // VP36
	ILI9881C_COMMAND_INSTR(0xAE, 0x4C), // VP24
	...
	// N-GAMMA
	ILI9881C_COMMAND_INSTR(0xC0, 0x08), // VN255
	ILI9881C_COMMAND_INSTR(0xC1, 0x11), // VN251
	ILI9881C_COMMAND_INSTR(0xC2, 0x19), // VN247
	ILI9881C_COMMAND_INSTR(0xC3, 0x0D), // VN243
	ILI9881C_COMMAND_INSTR(0xC4, 0x0D), // VN239
	ILI9881C_COMMAND_INSTR(0xC5, 0x1E), // VN231
	ILI9881C_COMMAND_INSTR(0xC6, 0x14), // VN219
	ILI9881C_COMMAND_INSTR(0xC7, 0x17), // VN203
	ILI9881C_COMMAND_INSTR(0xC8, 0x4F), // VN175
	ILI9881C_COMMAND_INSTR(0xC9, 0x1A), // VN144
	ILI9881C_COMMAND_INSTR(0xCA, 0x27), // VN111
	ILI9881C_COMMAND_INSTR(0xCB, 0x49), // VN80
	ILI9881C_COMMAND_INSTR(0xCC, 0x1A), // VN52
	ILI9881C_COMMAND_INSTR(0xCD, 0x18), // VN36
	ILI9881C_COMMAND_INSTR(0xCE, 0x4C), // VN24
	ILI9881C_COMMAND_INSTR(0xCF, 0x33), // VN16
...
static int ili9881c_prepare(struct drm_panel *panel)
{
	...
	for (i = 0; i < ctx->desc->init_length; i++) {
		...
		if (instr->op == ILI9881C_SWITCH_PAGE) {
			...
			pr_info("[ili9881c] SWITCH_PAGE -> 0x%02x (ret=%d)\n",
				instr->arg.page, ret);
		} else if (instr->op == ILI9881C_COMMAND) {
			ret = ili9881c_send_cmd_data(ctx,
							instr->arg.cmd.cmd,
							instr->arg.cmd.data);
			pr_info("[ili9881c] CMD 0x%02x DATA 0x%02x (ret=%d)\n",
				instr->arg.cmd.cmd,
				instr->arg.cmd.data,
				ret);
		}
		...
		if (ret) {
			dev_err(&ctx->dsi->dev,
				"[ili9881c] Failed at step %d (op=%d)\n",
				i, instr->op);
			return ret;
		}
...
static int ili9881c_dsi_probe(struct mipi_dsi_device *dsi)
{
	...
	if (IS_ERR(ctx->reset)) {
		...
		if (ret != -EPROBE_DEFER)
			dev_err(&dsi->dev, "cannot get reset GPIO: %d\n", ret);
		return ret;
	}

	ret = drm_panel_of_backlight(&ctx->panel);
	if (ret){
		dev_err(&dsi->dev, "cannot get backlight %d\n", ret);
		return ret;
	}
